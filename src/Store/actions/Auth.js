...
export const auth = (email,password, isSignUp) => {
    return dispatch => {
       ...
       let url = 'https://www.googleapis.com/identitytoolkit/v3/relyingparty/signupNewUser?key=AIzaSyAVmbxL7Vg9l5Y9y_9kfkzRJESRkEpf2yI'
        if(!isSignUp){
            url = 'https://www.googleapis.com/identitytoolkit/v3/relyingparty/verifyPassword?key=AIzaSyAVmbxL7Vg9l5Y9y_9kfkzRJESRkEpf2yI'
        }
