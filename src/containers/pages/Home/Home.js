        ...
        return(
            <Aux> 
                ...
                <option value='Furniture'>Furniture</option>
                   ...
                   <div class="container">
                   <p style={{color:'#777', paddingTop:'1em', fontSize:'1.6em',textAlign:'center'}}>It Simple to Use, Start Using Today</p>
                       <div class="row">
                       <div class="col-lg-6">
                        <div className={classes.Join}>
                            <p>You Can Sign Up Today as a Professional/Artisian</p>
                            <p>You Have the ability to list as many skills as possible on your profile page and be hired for job
                                  at almost zero cost</p>
                         <Button  btnType="Success"> <Link to="/register">Sign Up as Servive Provider</Link></Button>
                        </div>
                       </div>

                       <div class="col-lg-6">
                       <div className={classes.Join}>
                            <p>You Can Sign Up Today as a Client</p>
                            <p>You Have the ability to Hire any Artisian 
                                or proffessional at almost no cost</p>
                            <Button Link="/sign-up"  btnType="Success"><Link to="/register">Sign Up as Client</Link></Button>
                        </div>
                       </div>
